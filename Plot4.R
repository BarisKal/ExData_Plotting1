...
par(mfrow = c(2,2))
plot(subdata$DateTime, subdata$Global_active_power, type="line", col="black",xlab = "", ylab = "Global Active Power (Kilowats)")
plot(subdata$DateTime, subdata$Voltage, type="line", col="black",xlab = "", ylab = "Voltage")
...
plot(subdata$DateTime, subdata$Global_reactive_power, type="line", col="black",xlab = "", ylab = "Global_reactive_power")
